                ...
                <div class="w3-agile-top-info">	
                    <div class="w3-welcome-grids">
                        ...
                        <div class="col-md-5 w3ls-welcome-img1">
                            <img src="<?php echo base_url(); ?>assets/images/w1.jpg" alt="" />
                        </div>
                        <div class="clearfix"> </div>
                    </div>
                    <div class="w3-welcome-grids w3-welcome-bottom">
                        <div class="col-md-5 w3ls-welcome-img1 w3ls-welcome-img2">
                            <img src="<?php echo base_url(); ?>assets/images/w2.jpg" alt="" />
                        </div>
                        <div class="col-md-7 w3-welcome-left">
        ...
        <div class="jarallax  stats-agileits" id="stats">
            <div class="stats-info agileits w3layouts">
                ...
                <div class="col-md-3 col-sm-3 stats-grid stats-grid-4 agileits w3layouts">
                    <div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='4535' data-delay='3' data-increment="2">4535</div>
                    <div class="stat-info-w3ls">
        ...
        <div class="capabilities" id="capabilities">
            <div class="container">
                <h4 class="title-w3">Capabilities</h4>
        ...
        <div class="team" id="team">
            <div class="col-md-6 agile-team-grids">
                ...
                <div class="col-md-6 team-grid">
                    <div class="team-img">
                        <img src="<?php echo base_url(); ?>assets/images/t4.jpg" class="img-responsive" alt=" " />
                        <figcaption class="overlay">
                            <h4>Pattrick</h4>
                            <span>Lorem Ipsum</span>
                            <div class="w3l-social">
        ...
        <div class="gallery"  id="gallery">
            <div class="container">
                <h4 class="title-w3">Vehicles Gallery</h4>
                ...
                <div class="gallery-grids-row">
                    <div class="col-md-4 gallery-grid">
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g1.jpg" class="jzBoxLink item-hover" title="Maecenas sodales tortor ac ligula ultrices dictum et quis urna.">  
                        ...
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g2.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g2.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>    			
                        ...
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g7.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g7.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>    			
                    ...
                    <div class="col-md-4 gallery-grid">
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g3.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g3.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>    			
                        ...
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g4.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g4.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>    			
                    ...
                    <div class="col-md-4 gallery-grid">
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g6.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g6.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>  
                        ...
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g8.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g8.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>    			
                        ...
                        <div class="wpf-demo-4">  
                            <a href="<?php echo base_url(); ?>assets/images/g5.jpg" class="jzBoxLink item-hover" title="Etiam pulvinar metus neque eget porttitor massa.">  
                                <img src="<?php echo base_url(); ?>assets/images/g5.jpg" alt=" " class="img-responsive" />
                                <div class="view-caption">
                                    <p>Our Gallery</p>
                                </div> 
                            </a>    			
        ...
        <div class="map-w3ls">
            ...
            <div class="contact-agile" id="contact">
                <div class="contact-left">
                    <h6>Contact us</h6>
                    <p>14 Tottenham Road,<br> London, England.</p>
                    <p><a href="mailto:info@example.com" class="a1" >mail@example.com</a></p>
