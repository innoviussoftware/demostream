        ...
        <div class="col-md-offset-0 col-md-4">
            ...
            <div class="row top-title" style="font-size: 14px;background-color: #8B008B;color: white;">		
                ...
                <div class="col-xs-8" style="text-align: left;">
                    ...
                    <a href="#" onclick="history.back();" style="color:#fff;"><span class="fa fa-arrow-left"></span></a>&nbsp; <b>Payment</b>
    ...
    <div class="row" style="height:450px;" id="payment-stripe"> 
        ...
        <div class="col-md-offset-0 col-md-4 col-xs-12"  style="background-color: whitesmoke;">
            ...
            <div class="agileits-login" style="font-size: 13px;">
                ...
                <form class="form-horizontal" id="payment" method="post" action="<?php echo base_url('Purchase/payment_donation'); ?>">
