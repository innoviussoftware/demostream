...
if ($video['campaigndetails'] != '') {
    ...
    $video_id = $video['campaigndetails'][0]['VideoID'];
...
<div class="container middle paper-craft-middle">
    <div class="row">	
        ...
        <!--<p class="active" style="background-color: gold;padding: 5px 20px !important; */border-top-left-radius: 1em;border-top-right-radius: 1em;border-top-left-radius: 1em;text-align: center;width: 100%;float: right;/* right: 15%; */position: relative;">
                <a href="#" class="poweredby" data-toggle="modal" data-target="#poweredBy">Powered By Demostream</a></p>-->			


            <!--<ul class="" id="paper-craft-ul" style="padding: 0px !important;float:right;width: 80%;">
                    <li class="active" style="background-color: gold;padding: 5px 20px !important;border-top-left-radius: 1em;border-top-right-radius: 1em;">
                    <a href="#" class="poweredby" data-toggle="modal" data-target="#poweredBy">Powered By Demostream</a></li>				
    </ul>-->
            ...
            <!--<ul class="" id="paper-craft-ul" style="padding: 0px !important;width: 100%;background: black;">
                    <li class="active" style="border-top-left-radius: 1em;border-top-right-radius: 1em;width: 50%;/* background: gold; */">
                    <a href="#">
                    <img src="<?php echo base_url(); ?>assets/images/video.png" class="video-imgs" style="background: white;border-top-left-radius: 1em;">
                    </a>
                    
                    </li>	
                    <li class="active" style="background-color: #fff;border-top-left-radius: 1em;border-top-right-radius: 1em;width: 50%;">
                            <a href="#">
                            <img src="<?php echo base_url(); ?>assets/images/live1.png" class="live-img" style="">
                    </a>
                    </li>			
    </ul>-->
    ...
    <div class="row" style="">
        ...
        <div class="col-md-offset-0 col-md-4 col-xs-12 bg-video about-pad" id="mob" style="max-height: 500px;">		
            <div class="iframe">
...
<!--<img  class="img-responsive" id="donate1" style="transform: scale(1);" src="<?php echo base_url(); ?>assets/images/icons/new/donate2.png">-->
                ...
                <a download id="hover-down" style="cursor: pointer;" onclick="<?php if ($IsSubscribed == 2) { ?>alert('Please Subscribe');<?php }if ($IsSubscribed == 0) { ?> location.replace('<?php echo base_url(); ?>Hauth/users');<?php } ?>">
...
<?php if ($video_path != 'null' && $video_path != '' && $vimeo == '' && $ext == '' && $IsSubscribed == 1) { ?>
                        $.ajax({
                        type: "GET",
                                url: video_url,
